...
public class QuantityMeasurementTest {
    ...
    public void givenSameType_WhenEqual_ReturnTrue() throws QuantityMeasurementException {
        QuantityMeasurement value1 = new QuantityMeasurement(1, Unit.FEET);
        QuantityMeasurement value2 = new QuantityMeasurement(1, Unit.FEET);
        boolean isEqual = QuantityMeasurement.compare(value1, value2);
        Assert.assertTrue(isEqual);
    }
    @Test
    public void givenSameFeetValue_WhenEqual_ReturnTrue() throws QuantityMeasurementException {
        QuantityMeasurement value1 = new QuantityMeasurement(12, Unit.FEET);
        QuantityMeasurement value2 = new QuantityMeasurement(12, Unit.FEET);
        boolean isEqual = QuantityMeasurement.compare(value1, value2);
        Assert.assertTrue(isEqual);
    }
    ...
    public void givenInchNull_WhenNotEqual_ReturnFalse() {
        ...
        try {
            QuantityMeasurement.compare(value1, null);
        } catch (QuantityMeasurementException e) {
            Assert.assertEquals(QuantityMeasurementException.ExceptionType.NULL_POINTER_EXCEPTION, e.type);
        }
    }
    ...
    public void givenInchAndInch_WhenGetAdded_ReturnResult()  {
        ...
        double result = QuantityMeasurement.addition(value1, value2);
    ...
    public void givenLitreAndML_WhenGetAdded_ReturnResult() {
        ...
        QuantityMeasurement value2 = new QuantityMeasurement(1000, Unit.ML);
        double result = QuantityMeasurement.addition(value1, value2);
